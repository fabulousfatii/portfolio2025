...
const Card = ({icon:Icon, title, description,navigate}) => {
  return (
    <NavLink to={navigate} className=" w-64 h-48 lg:h-80 bg-gray-900/10 bg-opacity-40 border border-cyan-600  rounded-2xl backdrop-blur-lg hover:bg-opacity-50 transition-all duration-300 hover:scale-105 hover:bg-cyan-950 cursor-pointer">
