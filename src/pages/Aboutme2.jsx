...
<div className='sticky hidden md:block bg-blue-500 w-32 h-32 2xl:w-52 2xl:h-52   ml-[40%] left-64 top-1/2 rounded-full blur-[100px]'></div>
  ...
  <div className="bg-gray-900/20 rounded-2xl  border border-gray-700/50 backdrop-blur-xl p-6 relative group hover:border-gray-600/50 transition-all duration-500">
            ...
            <div className="relative z-10 ">
              ...
              <h3 className=" text-blue-500 font-bold 2xl:text-2xl"> Mern stack internship</h3>
  ...
  <div className="bg-gray-900/20  rounded-2xl border border-gray-700/50 backdrop-blur-xl p-6 relative group hover:border-gray-600/50 transition-all duration-500">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-blue-500 text-wrap  font-bold 2xl:text-2xl">Bachelor of Science in Computer Science  </h3>
