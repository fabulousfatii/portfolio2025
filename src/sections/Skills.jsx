    ...
    return (
        <div>
            <div className=' h-full overflow-x-hidden relative flex flex-col p-4   items-center '>
                {/* Background Gradient */}
      <div className="absolute top-5 right-0 w-72 h-96 circle1 rounded-full blur-[200px]"></div>
      <div className="absolute bottom-32 left-0 w-40 h-20 circle1 rounded-full blur-[100px]"></div>



                <h1 className="text-5xl font-bold mt-30 mb-20 header"> Skills</h1>

                <div className='flex gap-x-32 mb-4  '>
                ...
                <div className='flex gap-x-18 mb-4'>
                ...
                <div className='flex gap-x-18 mx-5 mb-32 '>
