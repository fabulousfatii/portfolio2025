...
const Card = ({icon:Icon,image, title, description,link}) => {
  return (
    <>
      {/* {link?( */}
        <a href={link? link: null} className=" w-64 2xl:w-80 h-80 lg:h-80 2xl:h-96 bg-gray-900/10 bg-opacity-40 border border-gray-500  rounded-2xl backdrop-blur-lg hover:bg-opacity-50 transition-all duration-300 hover:scale-105 hover:bg-blue-850 cursor-pointer">
