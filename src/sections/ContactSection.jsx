import { GitBranch, GitBranchPlusIcon, GitCommit, GitGraph, Mail, MailIcon } from "lucide-react"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                >
                <svg viewBox="0 0 24 24" width={30}  fill="#4dd581" xmlns="http://www.w3.org/2000/svg" stroke="#4dd581"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> 
