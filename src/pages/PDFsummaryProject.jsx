...
const PDFsummaryProject = () => {

    const features= [
        "user authentication",
        "upload pdf",
        "Ai generated summary of pdf",
        "stripe integration for buying plan",
        "download summary ",
        "responsive design",
        "summeries display",
...
<div className="w-12 h-12 bg-gradient-to-br from-sky-500/20 to-sky-400/10 mt-32 rounded-full flex items-center justify-center border border-sky-500/30">
 ...
 <h1 className='z-20 header mt-3 text-2xl md:text-5xl text-center font-bold text-shadow-lg text-shadow-gray-00'>PDF Summary <br /> website</h1>
 ...
 <div className=' mt-5'>
  ...
  <p className='z-20 text-md mt-15 md:text-lg  text-center p-10  text-shadow-lg text-shadow-gray-00'>
...
{/* features */}
  <h1 className='z-20  mt-7 text-2xl md:text-5xl text-center font-bold '>Features</h1>

    <div className='flex gap-2 md:gap-6 mt-10 flex-wrap md:px-32'>
        {features.map((feature,index)=>{
          return(
            <span key={index} className=' md:w-40 mt-2 p-1 text-center  rounded-full  backdrop-blur-lg border border-white/20 drop-shadow-sky-700 ring ring-cyan-600 shadow-cyan-600 hover:text-cyan-600 '>{feature}</span>
          )
  ...
  <h1 className='z-20  mt-15 text-2xl md:text-5xl text-center font-bold '>Tools</h1>
    ...
    <div className='flex gap-2 md:gap-6 mt-10 flex-wrap md:px-32'>
     ...
     <div className='w-full mt-15 flex flex-wrap gap-4  '>
          <img className='w-xl' src="/assets/pdf1.png" alt="" />
          <img className='w-xl' src="/assets/pdf2.png" alt="" />
          <img className='w-xl' src="/assets/pdf3.png" alt="" />
    </div>
    </div>
    </div>
...
export default PDFsummaryProject